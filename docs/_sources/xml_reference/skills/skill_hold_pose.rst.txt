...
Defined at line 8 of file :doc:`skills/skill_hold_pose.xml <../model_files/pitasc_library/skills/skill_hold_pose_xml>` in package **pitasc_library**.
...
**skill_hold_pose** is used in the following examples:
