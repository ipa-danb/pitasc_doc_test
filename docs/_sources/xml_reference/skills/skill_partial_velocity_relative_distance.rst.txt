...
Defined at line 92 of file :doc:`skills/skill_partial_velocity.xml <../model_files/pitasc_library/skills/skill_partial_velocity_xml>` in package **pitasc_library**.
...
**Basic** parameters:
  ...
  | **distances** : csv:float
  |  Travel distance after that the skill stops, in [m].
  |  **Default**: 0.01
...
**Expert** parameters:
  ...
  |  **Default**: odict_keys(['monitor_relative_distance'])
