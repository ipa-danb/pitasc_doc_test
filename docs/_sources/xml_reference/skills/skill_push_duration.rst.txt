...
Defined at line 105 of file :doc:`skills/skill_push.xml <../model_files/pitasc_library/skills/skill_push_xml>` in package **pitasc_library**.
...
=========
  ...
  | **Prototypes**
  |   :doc:`skill_push`, :doc:`skill_concurrency`, skill_single_robot, skill, object, dictionary, base, descriptive
...
**skill_push_duration** is used in the following examples:
