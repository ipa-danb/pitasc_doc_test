...
Defined at line 314 of file :doc:`monitors/io.xml <../model_files/pitasc_library/monitors/io_xml>` in package **pitasc_library**.
...
Examples
========
No examples found that make use of **monitor_ros_uint16_topic**