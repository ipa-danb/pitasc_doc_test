...
Defined at line 8 of file :doc:`skills/skill_lin_trajectory.xml <../model_files/pitasc_library/skills/skill_lin_trajectory_xml>` in package **pitasc_library**.
...
Examples
========
No examples found that make use of **skill_lin_trajectory_base**