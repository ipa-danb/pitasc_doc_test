...
Defined at line 9 of file :doc:`skills/spherical/skill_spherical.xml <../model_files/pitasc_library/skills/spherical/skill_spherical_xml>` in package **pitasc_library**.
...
Examples
========
No examples found that make use of **skill_spherical**