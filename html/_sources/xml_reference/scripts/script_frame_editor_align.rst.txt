...
Defined at line 118 of file :doc:`frame_editor/frame_editor.xml <../model_files/pitasc_library/frame_editor/frame_editor_xml>` in package **pitasc_library**.
...
**Required** parameters:
  ...
  |  **Default**: /frame_editor/align_frame
...
**Hidden** parameters:
  ...
  | **source** : string
  |  Name of the frame to be aligned to

Examples
========
No examples found that make use of **script_frame_editor_align**