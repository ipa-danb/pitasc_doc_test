...
Defined at line 405 of file :doc:`frame_editor/frame_editor.xml <../model_files/pitasc_library/frame_editor/frame_editor_xml>` in package **pitasc_library**.
...
**Expert** parameters:
  ...
  |  **Default**: odict_keys(['script_frame_editor_load_yaml'])
...
**frame_editor_load_yaml** is used in the following examples:
